...
// Update the Navbar component in resizable-navbar.tsx
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  useMotionValueEvent(scrollY, "change", (latest) => {
    if (latest > 150) {  // Changed from 100 to 150 for better trigger
      setVisible(true);
    } else {
      setVisible(false);
    }
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("fixed inset-x-0 top-4 z-40 w-full", className)}  // Changed to fixed with top-4
    >
