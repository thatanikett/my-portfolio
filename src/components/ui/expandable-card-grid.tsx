...
<div className="flex flex-col items-center mb-16">
  ...
  <p className="text-wrap md:text-nowrap text-lg md:text-xl text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto leading-relaxed" style={{marginLeft:"-11rem", marginBottom:"2rem"}}>
...
const cards = [
  ...
  },
  {
    ...
    src: "/images/weather-app.jpg", // Place image in public/images/weather-app.jpg
